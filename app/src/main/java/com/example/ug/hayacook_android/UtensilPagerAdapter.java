 ...
 */
public class UtensilPagerAdapter extends FragmentStatePagerAdapter {
    ...
    public UtensilPagerAdapter(FragmentManager fm) {
        super(fm);
        fragments[0] = new FragmentCookware();
        fragments[1] = new FragmentSeasoning();
        fragments[2] = new FragmentUtensilFinish();
    }
